...
if __name__ == '__main__':
    ...
    argparser.add_argument('--dataset', type=str, default='cit-patents')
    argparser.add_argument('--num-epochs', type=int, default=1)
    argparser.add_argument('--num-hidden', type=int, default=64)
    argparser.add_argument('--num-layers', type=int, default=4)
    argparser.add_argument('--fan-out', type=str, default='5,5,5,5')
    ...
    argparser.add_argument('--in-feat', type=int, default=100)
